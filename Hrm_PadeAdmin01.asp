...
<head>
  ...
  <title>HRM Verzatec | PADE Administrador 01</title>
    ...
    if not rsTrn.eof and not rsTrn.bof then
        ...
        do while not rsTrn.eof
            ...
            Select Case Elm
              ...
              Case "Tab001"
                Stb001 = trim(rsTrn("Trd_Texto"))
              Case "Tab002"
                Stb002 = trim(rsTrn("Trd_Texto"))
              Case "Tb1Hd1"
            ...
            <div class='col-xs-12'>
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="<%= Pan1St %>" id="main" >

                        <!-- Informacion 04 -->

                            <ul class="nav nav-tabs">

                                <li class="active"><a href="#activos" data-toggle="tab"><%= Stb001 %></a></li>
                                <li><a href="#agregar" data-toggle="tab"><%= Stb002 %></a></li>
                            </ul>
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-body">
                                                ...
                                                if not rs.bof and not rs.eof then
                                                    j = 0
                                                    %>
                                                    <form action="Hrm_PadeAdmin01.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Prm=1" & "&Sid=" & Sid %>" name="form2" method="post">
                                ...
                                <div class="tab-pane" id="agregar" >
                                    <form action="Hrm_PadeAdmin01.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Prm=1" & "&Sid=" & Sid %>" name="form1" method="post">
