...
<head>
  ...
  <title>HRM Verzatec | PADE - Encuesta 360° - Alta de Respuestas a Reactivos</title>
  ...
  <div class="content-wrapper">
    ...
    <!-- CONTENIDO PRINCIPAL INICIO -->
        ...
        <div class="box box-success">
            <form action="Hrm_PadeEnc3602.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>" name="form1" method="post">
        ...
        if not rs.bof and not rs.eof then
            ...
            <div class="box box-primary">
                <form action="Hrm_PadeEnc3602.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>" name="form2" method="post">
