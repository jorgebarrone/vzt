...
%>
  ...
  <div class="content-wrapper">
    ...
    Sgn = trim(Request.QueryString("Sgn"))
    Eja = Ejr - 1
    ...
    sqlImg = "select a.Emp_Foto,          a.Emp_Email,      " & _
             "       a.Emp_PlazaSuperior, c.Pue_Descripcion " & _
    ...
    if not rsImg.bof and not rsImg.eof then
        ...
        Pzs = trim(rsImg("Emp_PlazaSuperior"))
        Epd = trim(rsImg("Pue_Descripcion"))
        '<!-- Buscamos el No. de Empleado del Jefe y su correo electronico -->
        sqlPzs = "select Otm_Plaza_Superior, Otm_EmpresaFuente, Otm_Empleado from HRM10100 where Otm_EmpresaFuente = "& Cid &" and Otm_Plaza = "& Pzs &"  "
    ...
    if Sbt4b = "Sbt4b" then
        ...
        '<!-- Firma de Aceptación del Jefe -->
        if Sgn = 1 then
            if PwdJin = "" then
                %>
                <script>
                    alert('Favor de ingresar la Firma / Please input the password');
                </script>
                <%
            else
                ...
                dbconnk.open cnk
                sqlPJi = "select ID_Usuario from IN_Usuarios where Empleado = '"& Jin &"' and Contrasena = '"& PwdJin &"' "
                ...
                if not rsPJi.bof and not rsPJi.eof then
                    ...
                    %>
                    <script>
                        alert('No coincide las Firma / Wrong Password');
                    </script>
                    <%
                end if
            end if
        ...
        '<!-- Firma de Aceptación del Colaborador -->
        if Sgn = 2 then
            if PwdClb = "" then
                %>
                <script>
                ...
                if not rsPCl.bof and not rsPCl.eof then
                    ...
                    %>
                    <script>
                        alert('No coincide la Firma / Wrong Password');
                    </script>
                    <%
                end if
            end if
                                ...
                                <div class="box-body">
                                    <div class="box box-info box-solid">
                                        ...
                                        <div class="box-body" style="font-size: small">
                                            <form action="Hrm_PadeRetAlm.asp?Prm=4&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Nem=" & Nem & "&Nmb=" & Nmb & "&Cid="& Cid & "&Sid=" & Sid & "&Sgn=" & Sgn %>" name="form4" method="post">
                                                            ...
                                                            <div class="row fontawesome-icon-list">
                                                                <div class="col-md-3 col-sm-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        if Sgn = 1 then
                                                                            ...
                                                                            %>
                                                                            <input type="password" class="form-control" name="PwdJin" id="PwdJin" disabled value="**********" />
                                                                            <%
                                                                        end if
                                                                        %>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-3 col-sm-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        if Sgn = 1 then
                                                                            %>
                                                                            <input type="password" class="form-control" name="PwdClb" id="PwdClb" disabled />
                                                                            <%
                                                                        else
                                                                            %>
