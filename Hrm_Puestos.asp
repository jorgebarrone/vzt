                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="activos" >
                            <div class="box box-primary">
                                <form action="Hrm_Puestos.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>" name="form0" method="post">
                                        ...
                                        <div class="row fontawesome-icon-list">
                                            ...
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                                                    <label>&nbsp;</label>
                                                    <br/>
                                                    <button type="submit" class="btn btn-primary" name="SmBtn0" id="SmBtn0"><%= SmBtn0 %></button>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-4">
                                ...
                                <%
                                if Cpy > "" then
                                    sqlCpn = "select Cpy_RazonSocial from HRM10201 where Cpy_CompaniaID = '"& Cpy &"' "
                                    set rsCpn = dbconn.execute(sqlCpn)
                                    if not rsCpn.eof and not rsCpn.bof then Cpn = trim(rsCpn("Cpy_RazonSocial")) else Cpn = "" end if
                                    rsCpn.close
                                    set rsCpn = Nothing
                                    if Cpy = "T" then
                                        sqlLis = "select a.*,  b.Cpy_RazonSocial             " & _
                                                 "from HRM10210 a, HRM10201 b                " & _
                                                 "where a.Pue_CompaniaID = b.Cpy_CompaniaID  " & _
                                                 "order by a.Pue_CompaniaID, Pue_PuestoID    "
                                    else
                                        sqlLis = "select a.*,  b.Cpy_RazonSocial             " & _
                                                 "from HRM10210 a, HRM10201 b                " & _
                                                 "where a.Pue_CompaniaID = b.Cpy_CompaniaID  " & _
                                                 "and   a.Pue_CompaniaID = '"& Cpy &"'       " & _
                                                 "order by a.Pue_CompaniaID, Pue_PuestoID    "
                                        sqlLis = "select Pue_PuestoID,   Pue_Descripcion,    " & _
                                                 "       Pue_CompaniaID                      " & _
                                                 "from HRM10210                              " & _
                                                 "where Pue_CompaniaID = '"& Cpy &"'         " & _
                                                 "order by Pue_PuestoID                      "
                                    end if
                                    'response.write(sqlLis)
                                    set rs = dbconn.Execute(sqlLis)
                                    if not rs.bof and not rs.eof then
                                        %>
                                        <form action="Hrm_Puestos.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>" name="form2" method="post">
                                            <div class="box box-primary">
                                                <div class="box-header">
                                                    <h3 class="box-title"><%= BoxHd1 & " - " & Cpy & " - " & Cpn %></h3>
                                                </div>
                                                <div class="box-body">
                                                    <table id="example2" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            do while not rs.eof
                                                                i = i + 1
                                                                %>
                                                                <tr><td><%= trim(rs("Pue_PuestoID")) %></td><td><%= trim(rs("Pue_Descripcion")) %></td></tr>
                                                                <%
                                                                rs.movenext
                                                            loop
                                                            %>
