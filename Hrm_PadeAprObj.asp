  ...
  <div class="content-wrapper">
    ...
    if Sbt4 = "Sbt4" then
        ...
        if TotObj < Omn then
            ...
            TskScr = "Hrm_PadeAutObj.asp?Mdl=" & Mdl &  "&Trn=" & Trn & "&Ejr=" & Ejr & "&Nem=" & Eid & "&Nmb=" & Unm & "&Dsc=" & Dsc & "&Cid=" & Cid
            TskDsc = Dsc & " - " & TskTx1
    ...
    <section class="content">
        <div class="box box-success">
            <form action="Hrm_PadeAprObj.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1" method="post"  onsubmit="return validate()">
            ...
            if not rsO.bof and not rsO.eof then
                ...
                <div class="box box-primary">
                    <form action="Hrm_PadeAprObj.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1a" method="post">
                        ...
                        <div class="box-body">
                                ...
                                do while not rsO.eof
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="Hrm_PadeAprObj1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Ejr=" & Ejr & "&Eid=" & Eid & "&Dsc=" & Dsc & "&Ptd=" & rsO("Pod_Partida") %>">
                                                <%= rsO("Pod_Ponderacion") %>
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        do while not rsS.eof
                                            ...
                                            <tr>
                                                <td style="text-align: right">
                                                    ...
                                                    <a href="Hrm_PadeAprObj1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Ptd=" & rsS("Pod_Partida") %>">
                                                        <%= rsS("Pod_Ponderacion") %>
                                                    </a>
                                                </td>
                                                <td>&nbsp;</td>
                            ...
                            <div class="box-footer" style="text-align: center">
                                ...
                                if TotPnd = 100 then
                                    if SobPnd = 0 then
                                        %>
                                        <a href="Hrm_PadeAprObjI.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc %>" target="_blank" ><button type="button" class="btn btn-primary" name="Sbt3" id="Sbt3" value="Sbt3"><%= SmBtn3 %></button>&nbsp;&nbsp;&nbsp;</a>
                                        <button type="submit" class="btn btn-primary" name="Sbt4" id="Sbt4" value="Sbt4" style="background-color: green" ><%= SmBtn4 %></button>
                                        <%
                                    else
                                        %>
                                        <a href="Hrm_PadeAprObjI.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc %>" target="_blank" ><button type="button" class="btn btn-primary" name="Sbt3" id="Sbt3" value="Sbt3" disabled><%= SmBtn3 %></button>&nbsp;&nbsp;&nbsp;</a>
