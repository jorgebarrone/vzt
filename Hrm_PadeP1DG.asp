...
'----------------------------------------------
    ...
    sqlcia = "select Emp_CompaniaID from HRM10220 where Emp_CorporativoID = '5000' and Emp_EmpleadoID = '"& Eid &"'  "
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="<%= Pan1St %>" id="grales" >
                            <form action="Hrm_PadeP1DG.asp?Prm=1&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form1" method="post">
                        ...
                        <div class="<%= Pan2St %>" id="emergn" >
                            <form action="Hrm_PadeP1DG.asp?Prm=2&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form2" method="post">
                        ...
                        <div class="<%= Pan3St %>" id="funcns" >
                            <form action="Hrm_PadeP1DG.asp?Prm=3&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form3" method="post">
                        ...
                        <div class="<%= Pan4St %>" id="famlrs" >
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=4&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form4" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsDfm.eof and not rsDfm.bof then
                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=4&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form4a" method="post">
                        ...
                        <div class="<%= Pan5St %>" id="escolr" >
                            <div class="box box-warning" style="border-top-color: #3EACA8">
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=5&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form5" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsD.eof and not rsD.bof then
                                ...
                                <div class="box box-info" style="border-top-color: #A2D4AB">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=5&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form5a" method="post">
                        ...
                        <div class="<%= Pan6St %>" id="idioma" >
                            <div class="box box-warning" style="border-top-color: #83AE9B">
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=6&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form6" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsD.eof and not rsD.bof then
                                ...
                                <div class="box box-info" style="border-top-color: #C8C8A9">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=6&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form6a" method="post">
                        ...
                        <div class="<%= Pan7St %>" id="cursos" >
                            <div class="box box-warning" style="border-top-color: #2A363B">
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=7&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form7" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsD.eof and not rsD.bof then
                                ...
                                <div class="box box-info" style="border-top-color: #99B898">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=7&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form7a" method="post">
                        ...
                        <div class="<%= Pan8St %>" id="empleo" >
                            <div class="box box-warning" style="border-top-color: #2A363B">
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=8&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form8" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsD.eof and not rsD.bof then
                                ...
                                <div class="box box-info" style="border-top-color: #99B898">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=8&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form8a" method="post">
...
'                                                        DemFcs = Mid(DemFic,6,2) & "/" & Mid(DemFic,9,2) & "/" & Mid(DemFic,1,4) & " - " & Mid(DemFfn,6,2) & "/" & Mid(DemFfn,9,2) & "/" & Mid(DemFfn,1,4)
                        ...
                        <div class="<%= Pan9St %>" id="inters" >
                            <div class="box box-warning" style="border-top-color: #2A363B">
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=9&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form9" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsD.eof and not rsD.bof then
                                ...
                                <div class="box box-info" style="border-top-color: #99B898">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=9&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid & "&Eid=" & Eid %>" name="form9a" method="post">
                                            <table id="example5" class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        <th><%= Fr9Lb1 %></th>
