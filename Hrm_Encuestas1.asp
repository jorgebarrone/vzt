...
<head>
  ...
  <title>HRM Verzatec | Encuestas - Alta de Reactivos</title>
                                ...
                                do while not rs.eof
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="Hrm_Encuestas2.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Sci=" & trim(rs("Scp_ScriptID")) & "&Dsc=" & Dsc & "&Sri=" & trim(rs("Scp_ReactivoID")) %>">
