...
<head>
  ...
  <title>HRM Verzatec | Proceso de Administración del Desempeño (PADE - Administrador) </title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    EmpAlt = Request.Form("Emp_Alt")
    if trim(EmpAlt) = "" then
        EmpAlt = Uid
    end if

    sqlCia = "select Emp_CompaniaID from HRM10220 where Emp_Empleadoid = '"& EmpAlt &"' "
                            ...
                            <section class="sidebar">
                                <ul class="sidebar-menu">
                                    ...
                                    if not rsM3.bof and not rsM3.eof then
                                        ...
                                        sqlPlz = "select Emp_PlazaID from HRM10220 where Emp_EmpleadoID = '"& EmpAlt &"'  "
                                        ...
                                        Do while not rsM3.eof
                                            ...
                                            if date >= P1FecIniD and date <= P1FecFinD then
                                                if CInt(rsM3("Psm_Estatus")) = 0 then
                                                    ...
                                                    semelm = "red"
                                                    %>
                                                    <li><a href="Hrm_PadeEnc3604.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & EmpAlt & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsM3("Trd_Texto") %></a></li>
                                                    <%
                                                else
                                                    if CInt(rsM3("Psm_Estatus")) = 1 then
                                                        ...
                                                        semelm = "green"
                                                        %>
                                                        <li><a href="Hrm_PadeCnsM360.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & EmpAlt & "&Nmb=" & Unm & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Cid=" & Cid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsM3("Trd_Texto") %></a></li>
                                                        <%
                                                    end if
                                                end if
                                            else
                                    ...
                                    if not rsEnc.bof and not rsEnc.eof then
                                        ...
                                        Do while not rsEnc.eof
                                            ...
                                            if date >= P1FecIniD and date <= P1FecFinD then
                                                %>
                                                <li><a href="Hrm_PadeAutEnc.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & EmpAlt & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsEnc("Emp_NombreCompleto") %></label></a></li>
                                                <%
                                            else
                                                %>
                                    ...
                                    if not rsEnc.bof and not rsEnc.eof then
                                        ...
                                        sqlest = "select a.*, b.Emp_NombreCompleto, c.Psm_Estatus,         " & _
                                                 ...
                                                 "and   a.M36_EvaluadorID   = '"& EmpAlt &"'                  " & _
                                    ...
                                    if Tvl < 3 then
                                        ...
                                        if not rsP3.bof and not rsP3.eof then
                                            ...
                                            Do while not rsP3.eof
                                                ...
                                                if date >= P1FecIniD and date <= P1FecFinD then
                                                    %>
                                                    <li><a href="Hrm_PadeAprObj.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & EmpAlt & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP3("Trd_Texto") %></a></li>
                                                    <%
                                                else
                                                    %>
                                                ...
                                                if Tvl < 3 then
                                                    if date >= P2FecIniD and date <= P2FecFinD then
                                                        if CInt(rsP3("Psm_Estatus")) = 0 then
                                                            ...
                                                            semelm = "red"
                                                            %>
                                                            <li><a href="Hrm_PadeCieObj.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & EmpAlt & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP3("Trd_Texto") %></a></li>
                                                            <%
                                                        else
                                                            if CInt(rsP3("Psm_Estatus")) = 1 then
                                                                P2Est = P2Est + 1
                                                                ...
                                                                semelm = "green"
                                                                %>
                                                                <li><a href="Hrm_PadeCnsCieObj.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & EmpAlt & "&Nmb=" & Unm & "&Cid=" & Cid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP3("Trd_Texto") %></a></li>
                                                                <%
                                                            end if
                                                        end if
                                                    else
                                                    ...
                                                    if date >= P2FecIniD and date <= P2FecFinD then
                                                        if CInt(rsP3("Psm_Estatus")) = 0 then
                                                            ...
                                                            if CInt(rsP3("Psm_Estatus")) = 1 then
                                                                ...
                                                                semelm = "green"
                                                                %>
                                                                <li><a href="Hrm_PadeCnsCieHab.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & EmpAlt & "&Nmb=" & Unm & "&Cid=" & Cid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP3("Trd_Texto") %></a></li>
                                                                <%
                                                            end if
                                                        end if
                                                    else
                                        ...
                                        Do while not rsP4.eof
                                            ...
                                            if date >= P2FecIniD and date <= P2FecFinD then
                                                if CInt(rsP4("Psm_Estatus")) = 0 then
                                                    ...
                                                    semelm = "red"
                                                    %>
                                                    <li><a href="Hrm_PadeRetAlm.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & EmpAlt & "&Nmb=" & Unm & "&Cid=" & Cid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP4("Trd_Texto") %></a></li>
                                                    <%
                                                else
                                                    if CInt(rsP3("Psm_Estatus")) = 1 then
                                                        P2Est = P2Est + 1
