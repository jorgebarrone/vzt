...
'              response.write(sqldel)
  ...
  <div class="content-wrapper">
    ...
    <% call hdr(Dsc,"- Respuestas a Reactivos") %>
                    ...
                    <div class="row fontawesome-icon-list">
                        <div class="col-md-3 col-sm-4">
                            <div class="form-group">
                                ...
                                <label>Encuesta:</label></br><label><%= Dsc %></label>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4">
                            <div class="form-group">
                                <label>Factor:</label></br><label><%= Std %></label>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4">
                            <div class="form-group">
                                <label>No Pregunta/Reactivo:</label></br><label><%= Sri %></label>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4">
                            <div class="form-group">
                                <label>Pregunta/Reactivo:</label></br><label><%= Srd %></label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="form-group">
                                <label style="color: #f00">* &nbsp;</label><label>Secuencia</label>
                                <input type="number" class="form-control" name="Ord" id="Ord" placeholder="Secuencia" required />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="number" step=".01" class="form-control" name="Rvn" id="Rvn" placeholder="<%= Fr1Ph6 %>" required />
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4">
                            <div class="form-group">
