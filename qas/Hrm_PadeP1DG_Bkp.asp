...
<head>
  ...
  <title>HRM Verzatec | PADE Datos Generales (Paso 1)</title>
...
'----------------------------------------------
    ...
    sqlcia = "select Emp_CompaniaID from HRM10220 where Emp_CorporativoID = '5000' and Emp_EmpleadoID = '"& Uid &"'  "
    ...
    if Sbt1 = "Sbt1" then
        ...
        if not rsv.bof and not rsv.eof then
            sqlupd = "update HRM10510                                                " & _
                     ...
                     "    Dgr_Skytel        = '"& trim(Request.Form("Skytel")) &"',  " & _
                     "    Dgr_ClaveSkytel   = '"& trim(Request.Form("ClvSky")) &"',  " & _
            ...
            sqlins = "insert into HRM10510                       " & _
                     ...
                     "    '"& trim(Request.Form("Skytel")) &"',  " & _
                     "    '"& trim(Request.Form("ClvSky")) &"',  " & _
...
'<- FORMA 03 - DATOS FUNCIONES   (INICIO) ->
    if Sbt3 = "Sbt3" then
        sqlval = "select Dfn_EmpleadoID from HRM10512    " & _
                 ...
                 "and   Dfn_EmpleadoID    = '"& Uid &"'  "
        set rsv = dbconn.execute(sqlval)

        if not rsv.bof and not rsv.eof then
            sqlupd = "update HRM10512                                              " & _
                     "set Dfn_Funciones  = '"& trim(Request.Form("Funcns")) &"'    " & _
                     "where Dfn_CorporativoID = '5000'                             " & _
                     "and   Dfn_CompaniaID    = '"& Cid &"'                        " & _
                     "and   Dfn_EmpleadoID    = '"& Uid &"'                        "
            set rsu = dbconn.execute(sqlupd)
            ...
            for i = 1 to Ind
                ...
                if Request.Form("elm"&i) = "on" then
                    sqldel = "delete HRM10516                          " & _
                             ...
                             "and   Dcr_EmpleadoID    = '"& Uid &"'    " & _
                             "and   Dcr_Curso         = '"& DidCur &"' "
                    set rsd = dbconn.execute(sqldel)
                end if
            next
        end if
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="<%= Pan1St %>" id="grales" >
                            <form action="Hrm_PadeP1DG.asp?Prm=1&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form1" method="post">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row fontawesome-icon-list">
                                                    ...
                                                    <select class="form-control" size="1" id="TipViv" name="TipViv" required>
                                                        ...
                                                        if TipViv = "S" then
                                                            ...
                                                            if TipViv = "N" then
                                                                ...
                                                                %>
                                                                <option class="form-control" value="M"><%= Fr1S3o1 %></option>
                                                                <option class="form-control" value="F"><%= Fr1S3o2 %></option>
                                                                <%
                                                            end if
                                                        end if
                                                        %>
                                            ...
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                                                    <label><%= Fr1Lb30 %></label>
                                                    <input type="text" class="form-control" name="Skytel" id="Skytel" value="<%= Skytel %>" placeholder="<%= Fr1Ph30 %>" />
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                                                    <label><%= Fr1Lb31 %></label>
                                                    <input type="text" class="form-control" name="ClvSky" id="ClvSky" value="<%= ClvSky %>" placeholder="<%= Fr1Ph31 %>" />
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                        ...
                        <div class="<%= Pan2St %>" id="emergn" >
                            <form action="Hrm_PadeP1DG.asp?Prm=2&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form2" method="post">
                                <div class="box box-danger">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label><%= Fr2Lb2 %></label>
                                            <textarea class="form-control" rows="3" placeholder="<%= Fr2Ph2 %>"><%= Alergs %></textarea>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="<%= Pan3St %>" id="funcns" >
                            <form action="Hrm_PadeP1DG.asp?Prm=3&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form3" method="post">
                        ...
                        <div class="<%= Pan4St %>" id="famlrs" >
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=4&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form4" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsDfm.eof and not rsDfm.bof then
                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=4&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form4a" method="post">
                        ...
                        <div class="<%= Pan5St %>" id="escolr" >
                            <div class="box box-warning" style="border-top-color: #3EACA8">
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=5&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form5" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsD.eof and not rsD.bof then
                                ...
                                <div class="box box-info" style="border-top-color: #A2D4AB">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=5&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form5a" method="post">
                        ...
                        <div class="<%= Pan6St %>" id="idioma" >
                            <div class="box box-warning" style="border-top-color: #83AE9B">
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=6&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form6" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsD.eof and not rsD.bof then
                                ...
                                <div class="box box-info" style="border-top-color: #C8C8A9">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=6&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form6a" method="post">
                        ...
                        <div class="<%= Pan7St %>" id="cursos" >
                            <div class="box box-warning" style="border-top-color: #2A363B">
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=7&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form7" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsD.eof and not rsD.bof then
                                ...
                                <div class="box box-info" style="border-top-color: #99B898">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=7&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form7a" method="post">
                        ...
                        <div class="<%= Pan8St %>" id="empleo" >
                            <div class="box box-warning" style="border-top-color: #2A363B">
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=8&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form8" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsD.eof and not rsD.bof then
                                ...
                                <div class="box box-info" style="border-top-color: #99B898">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=8&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form8a" method="post">
                        ...
                        <div class="<%= Pan9St %>" id="inters" >
                            <div class="box box-warning" style="border-top-color: #2A363B">
                                <div class="box-body">
                                    <form action="Hrm_PadeP1DG.asp?Prm=9&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form9" method="post">
                                        <div class="row fontawesome-icon-list">
                                            <div class="col-md-3 col-sm-4">
                                                <div class="form-group">
                            ...
                            if not rsD.eof and not rsD.bof then
                                ...
                                <div class="box box-info" style="border-top-color: #99B898">
                                    ...
                                    <div class="box-body">
                                        <form action="Hrm_PadeP1DG.asp?Prm=9&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form9a" method="post">
                                            <table id="example5" class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        <th><%= Fr9Lb1 %></th>
