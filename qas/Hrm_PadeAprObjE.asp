...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if Tvl = 1 then
        response.redirect "Hrm_PadeAprObj.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Ejr=" & Ejr
    end if
    ...
    if Sbt4 = "Sbt4" then
        ...
        if TotObj < Omn then
            ...
            TskScr = "Hrm_PadeAutObjE.asp?Mdl=" & Mdl &  "&Trn=" & Trn & "&Ejr=" & Ejr & "&Nem=" & Uid & "&Nmb=" & Unm & "&Dsc=" & Dsc & "&Cid=" & Cid
            TskDsc = Dsc & " - " & TskTx1
    ...
    <section class="content">
      <div class="box box-success">
        ...
        <div class="box box-primary">
            <form action="Hrm_PadeAprObjE.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1" method="post">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            if trim(rsO("Pod_Descripcion")) = "UAFIR" then
                                                ...
                                                %>
                                                <a href="Hrm_PadeAprObjE1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Ptd=" & rsO("Pod_Partida") %>">
                                                    <%= rsO("Pod_Ponderacion") %>
                                                </a>
                                                <%
                                            end if
                                        ...
                                        do while not rsS.eof
                                            ...
                                            <tr>
                                                <td style="text-align: right">
                                                    ...
                                                    <a href="Hrm_PadeAprObjE1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Ptd=" & rsS("Pod_Partida") %>">
                                                        <%= rsS("Pod_Ponderacion") %>
                                                    </a>
                                                </td>
                                                <td>&nbsp;</td>
