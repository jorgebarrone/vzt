...
<head>
  ...
  <title>HRM Verzatec | PADE - Consulta Encuesta 360°</title>
...
'                myMail.AddAttachment "C:\inetpub\wwwroot\Hrm\reports\Attch01.txt"
    ...
    <section class="content">
        ...
        <form action="Hrm_PadeEnc3603.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Nem=" & Nem & "&Nmb=" & Nmb & "&Cid=" & Cid & "&Sid=" & Sid %>" name="form1" method="post">
