...
<head>
  ...
  <title>HRM Verzatec | PADE - Encuesta Habilidades - Alta de Reactivos</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <% call hdr("PADE","Encuesta de Habilidades - Alta de Preguntas/Reactivos") %>
    ...
    <section class="content">
        ...
        <div class="box box-success">
            <form action="Hrm_PadeEncHab1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>" name="form1" method="post">
        ...
        if not rs.bof and not rs.eof then
            ...
            <div class="box box-primary">
                <form action="Hrm_PadeEncHab1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>" name="form2" method="post">
                                ...
                                do while not rs.eof
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="Hrm_PadeEncHab2.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Sci=" & trim(rs("Scp_ScriptID")) & "&Sri=" & trim(rs("Scp_ReactivoID")) %>">
