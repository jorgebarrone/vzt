...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    sqlCia = "select Emp_CompaniaID from HRM10220 where Emp_Empleadoid = '"& Uid &"' "
              ...
              <div class="box" style="border-top-color: #d99898; border-top-width: thick">
                  <div class="box-body">
                      ...
                      <div class="box-footer" style="text-align: center">
                          <%= BxFt03 %> <span class="label label-danger">Retraso</span>
                      </div>
                  </div>
              </div>
          </div>
                                  ...
                                  Do while not rsP3.eof
                                      ...
                                      if Tvl < 3 then
                                          if CInt(rsP3("Psm_Estatus")) = 0 then
                                              semelm = "red"
                                              %>
                                              <li><a href="Hrm_PadeCieObj.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Uid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP3("Trd_Texto") %></a></li>
                                              <%
                                          else
...
<!--  ***************** Cierre Objetivos Fin *****************  -->
                              ...
                              if not rsM3.bof and not rsM3.eof then
                                  ...
                                  Do while not rsM3.eof
                                      ...
                                      if CInt(rsM3("Psm_Estatus")) = 0 then
                                          semelm = "red"
                                          %>
                                          <li><a href="Hrm_PadeEnc3604.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Uid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsM3("Trd_Texto") %></a></li>
                                          <%
                                      else
                                          if CInt(rsM3("Psm_Estatus")) = 1 then
                                              ...
                                              semelm = "green"
                                              %>
                                              <li><a href="Hrm_PadeCnsM360.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Uid & "&Nmb=" & Unm & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsM3("Trd_Texto") %></a></li>
                                              <%
                                          end if
                                      end if
                                      rsM3.movenext
                              ...
                              if not rsEnc.bof and not rsEnc.eof then
                                  ...
                                  Do while not rsEnc.eof
                                      ...
                                      %>
                                      <li><a href="Hrm_PadeAutEnc.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Uid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsEnc("Emp_NombreCompleto") %></label></a></li>
                                      <%
                                      rsEnc.movenext
                                  Loop
                                  rsEnc.close
                              ...
                              if not rsEnc.bof and not rsEnc.eof then
                                  ...
                                  Do while not rsEnc.eof
                                      ...
                                      %>
                                      <li><a href="Hrm_PadeEnc3603.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Uid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsEnc("Emp_NombreCompleto") %></label></a></li>
                                      <%
                                      rsEnc.movenext
                                  Loop
                                  rsEnc.close
                          ...
                          if Tvl < 3 then
                              ...
                              if not rsP3.bof and not rsP3.eof then
                                  ...
                                  Do while not rsP3.eof
                                      ...
                                      %>
                                      <li><a href="Hrm_PadeAprObj.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Uid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP3("Trd_Texto") %></a></li>
                                      <%
                                      rsP3.movenext
                                  Loop
                                  rsP3.close
                                      ...
                                      do while not rsClb.eof
                                          if rsClb("Psm_Estatus") = 0 then
                                              ...
                                              if rsClb("Psm_Estatus") = 1 then
                                                  ...
                                                  semelm = "green"
                                                  %>
                                                  <li><a href="Hrm_PadeCnsObj.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & trim(rsClb("Emp_EmpleadoID")) & "&Nmb=" & trim(rsClb("Emp_NombreCompleto")) & "&Cid=" & trim(rsClb("Emp_CompaniaID")) & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsClb("Emp_NombreCompleto") %></label></a></li>
                                                  <%
                                              end if
                                          end if
                                          rsClb.movenext
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="box" style="border-top-color: #fff">
              <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-commenting"></i>&nbsp;&nbsp;<%= BxHd04 %></h3>
              </div>
              <div class="box" style="border-top-color: #4a0909; border-top-width: thick">
                  <div class="box-body">
                      <section class="sidebar">
                          <ul class="sidebar-menu">


<!--  ***************** Retroalimentación Ini *****************  -->
                          <%
                              ...
                              Do while not rsP4.eof
                                  if fr = 0 then
                                      ...
                                      if CInt(rsP4("Psm_Estatus")) = 0 then
                                          semelm = "red"
                                          %>
                                          <li><a href="Hrm_PadeRetAlm.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Uid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP4("Trd_Texto") %></a></li>
                                          <%
                                      else
                                          if CInt(rsP3("Psm_Estatus")) = 1 then
                                              semelm = "yellow"
                                              ...
                                              semelm = "green"
                                              %>
                                              <li><a href="Hrm_PadeRetAlm.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Uid & "&Nmb=" & Unm & "&Cid=" & Cid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP4("Trd_Texto") %></a></li>
                                              <%
                                          end if
                                      end if
                                      rsP4.movenext
...
<!--  ***************** Retroalimentación Fin *****************  -->
      ...
      <form action="index.asp?Sid=<%= Sid %>" name="formA0" method="post">
          <div class="box box-danger">
              ...
              <div class="box-body">
                  <div class="box-footer" style="text-align: center">
                      <button type="submit" class="btn btn-primary" name="Sbt1" id="Sbt1" value="Sbt1" onclick="sndeml()"><%= SmBtn1 %></button>
                  </div>
              </div>
          </div>
      </form>
...
<script>
    function sndeml() {
        Email.send("jorge.barron.e@gmail.com",
        "jorge.barron.e@gmail.com",
        "This is a subject",
        "this is the body",
        "smtp.gmail.com",
        "jorge.barron.e@gmail.com",
