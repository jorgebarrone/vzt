...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if Tvl = 1 then
        response.redirect "Hrm_PadeAutObj.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Ejr=" & Ejr & "&Nem=" & Nem & "&Cid=" & Cid
    end if
...
'        response.write("</br>")
        ...
        TskScr = "Hrm_PadeAprObjE.asp?Mdl=" & Mdl &  "&Trn=" & Trn & "&Ejr=" & Ejr & "&Nem=" & Uid & "&Nmb=" & Unm & "&Dsc=" & Dsc & "&Cid=" & Cid
        TskDsc = Dsc & " - " & TskTx2
    ...
    <section class="content">
      ...
      <div class="box box-success">
        ...
        <div class="box box-primary">
            <form action="Hrm_PadeAutObjE.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid & "&Nem=" & Nem & "&Nmb=" & Nmb & "&Cid=" & Cid %>" name="form1" method="post">
                <!-- form start -->
                <div class="box-body">
                <%
                EstNeg = "EST" & Ejr
