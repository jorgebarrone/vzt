...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    sqlCia = "select Emp_CompaniaID, Emp_PlazaID, Emp_PlazaSuperior, Emp_Email from HRM10220 where Emp_Empleadoid = '"& Uid &"' "
...
'        else
            ...
            if TotEvl < Omn then
                ...
                TskScr = "Hrm_PadeAutM360.asp?Mdl=" & Mdl &  "&Trn=" & Trn & "&Ejr=" & Ejr & "&Nem=" & Uid & "&Nmb=" & Unm & "&Dsc=" & Dsc & "&Cid=" & Cid
                TskDsc = Dsc & " - " & TskTx1
...
'<!-- -->
    ...
    '                myMail.AddAttachment "C:\inetpub\wwwroot\Hrm\reports\Attch01.txt"
                ...
                response.redirect "Hrm_EmpPADE.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Ejr=" & Ejr
            end if
'        end if
    end if
    %>
    ...
    <!-- CONTENIDO PRINCIPAL AQUI -->
        <div class="box box-primary">
            ...
            <form action="Hrm_PadeEnc3604.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1" method="post">
                <!-- form start -->
                <div class="box-body">
                    <div class="row fontawesome-icon-list">
                        <div class="col-md-3 col-sm-4">
            ...
            if not rsO.bof and not rsO.eof then
                ...
                %>
                <div class="box box-primary">
                    <form action="Hrm_PadeEnc3604.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1a" method="post">
                        <div class="box-header">
