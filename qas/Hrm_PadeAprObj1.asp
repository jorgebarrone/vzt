...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    sqlCia = "select Emp_CompaniaID, Emp_PlazaSuperior from HRM10220 where Emp_Empleadoid = '"& Uid &"' "
      ...
      '                  TotPnd = CInt(Request.Form("ObjPnd"))
       '             end if
        ...
        if TotPnd > 100 then
            ...
            response.redirect "Hrm_PadeAprObj.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Ejr=" & Ejr & "&Dsc=" & Dsc
'            response.write(sqlins)
    ...
    <section class="content">
        <div class="box box-success">
            <form action="Hrm_PadeAprObj1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid & "&Ptd=" & Ptd %>" name="form1" method="post">
