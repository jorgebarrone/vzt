...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if Tvl = 2 then
        response.redirect "Hrm_PadeAutObjE.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Ejr=" & Ejr & "&Nem=" & Nem & "&Nmb=" & Nmb & "&Dsc=" & Dsc & "&Cid=" & Cid
    end if
...
'        response.write("</br>")
        ...
        TskScr = "Hrm_PadeAprObj.asp?Mdl=" & Mdl &  "&Trn=" & Trn & "&Ejr=" & Ejr & "&Nem=" & Uid & "&Nmb=" & Unm & "&Dsc=" & Dsc & "&Cid=" & Cid
        TskDsc = Dsc & " - " & TskTx2
...
'            myMail.AddAttachment "C:\inetpub\wwwroot\Hrm\reports\Attch01.txt"
    ...
    <section class="content">
        <div class="box box-success">
            <form action="Hrm_PadeAutObj.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid & "&Nem=" & Nem & "&Nmb=" & Nmb & "&Cid=" & Cid %>" name="form1" method="post">
