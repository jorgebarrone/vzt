...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if Tvl = 2 then
        response.redirect "Hrm_PadeCieObjE.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Ejr=" & Ejr & "&Dsc=" & Dsc
    end if
...
'                myMail.AddAttachment "C:\inetpub\wwwroot\Hrm\reports\Attch01.txt"
    ...
    <section class="content">
        <div class="box box-success">
            <form action="Hrm_PadeCieObj.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1" method="post">
