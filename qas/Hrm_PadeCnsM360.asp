                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            do while not rsO.eof
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center"><% if EvlSts  = 0 then %><i class="fa fa-circle text-red"></i><%else %><i class="fa fa-circle text-gray"></i><% end if %></td>
                                    ...
                                    <td style="text-align: center"><% if EvlSts  = 4 then %><a href="Hrm_PadeCns360.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Nem & "&Nmb=" & Nmb & "&Cid=" & Cid & "&Eid=" & trim(rsO("M36_EvaluadorID")) & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-circle text-blue"></i></a><%else %><i class="fa fa-circle text-gray"></i><% end if %></td>
                                </tr>
                                <%
                                rsO.movenext
                            loop
