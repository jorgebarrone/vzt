...
<head>
  ...
  <title>HRM Verzatec | PADE - Encuesta Habilidades</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            <form action="Hrm_PadeEncHab.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>" name="form1" method="post">
        ...
        <%
        sqlLis = "select * from HRM10301 where Sch_Tipo = 'HAB'"
        ...
        if not rs.bof and not rs.eof then
            ...
            <div class="box box-primary">
                <form action="Hrm_PadeEncHab.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>" name="form2" method="post">
                                ...
                                do while not rs.eof
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="Hrm_PadeEncHab1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Sci=" & trim(rs("Sch_ScriptID")) %>">
