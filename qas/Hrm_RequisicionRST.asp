...
'                    response.write(sqlPlz)
                    ...
                    if EstOrg = 1 then
                        sqlpri = "select a.Plaza,                                               " & _
                                 ...
                                 "where a.Plaza_Superior = "& rsP("plaza") &"                   " & _
                                 "and   a.Publica        = 1                                    " & _
                                 "and   a.Estatus        = 1                                    "

                        set rs1 = dbconn1.execute(sqlpri)
'                        response.write(sqlpri)
                        if not rs1.eof and not rs1.bof then
                            do while not rs1.eof
                                ...
                                <tr>
                                    <td>
                                        <a href="Hrm_RequisicionRS1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Plz=" & trim(rs1("plaza")) %>">
                                            <%= rs1("plaza") %>
                                        </a>
                                    </td>
                                    <td>
                                ...
                                sqlseg = "select a.Plaza,                                               " & _
                                         ...
                                         "    and a.EmpresaFuente = c.EmpresaFuente                     " & _
                                         "	  and a.Empresa = c.Empresa                                 " & _
                                         "where a.Plaza_Superior = "& rs1("plaza") & "                  " & _
                                         "and   a.Publica        = 1                                    " & _
                                         "and   a.Estatus        = 1                                    "
                                set rs2 = dbconn1.execute(sqlseg)
'                                response.write(sqlseg)
                                if not rs2.eof and not rs2.bof then
                                    do while not rs2.eof
                                        ...
                                        <tr>
                                            <td>
                                                <a href="Hrm_RequisicionRS1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Plz=" & trim(rs2("plaza")) %>">
                                                    <%= rs2("plaza") %>
                                                </a>
                                            </td>
                                            <td>
                                        ...
                                        sqlter = "select a.Plaza,                                               " & _
                                                 ...
                                                 "    and a.EmpresaFuente = c.EmpresaFuente                     " & _
                                                 "	  and a.Empresa = c.Empresa                                 " & _
                                                 "where a.Plaza_Superior = "& rs2("plaza") & "                  " & _
                                                 "and   a.Publica        = 1                                    " & _
                                                 "and   a.Estatus        = 1                                    "
                                        set rs3 = dbconn1.execute(sqlter)
                                        ...
                                        if not rs3.eof and not rs3.bof then
                                            do while not rs3.eof
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="Hrm_RequisicionRS1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Plz=" & trim(rs3("plaza")) %>">
                                                            <%= rs3("plaza") %>
                                                        </a>
                                                    </td>
                                                    <td>
                                                ...
                                                sqlcua = "select a.Plaza,                                               " & _
                                                         ...
                                                         "    and a.EmpresaFuente = c.EmpresaFuente                     " & _
                                                         "	  and a.Empresa = c.Empresa                                 " & _
                                                         "where a.Plaza_Superior = "& rs3("plaza") & "                  " & _
                                                         "and   a.Publica        = 1                                    " & _
                                                         "and   a.Estatus        = 1                                    "
                                                set rs4 = dbconn1.execute(sqlcua)
                                                ...
                                                if not rs4.eof and not rs4.bof then
                                                    do while not rs4.eof
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="Hrm_RequisicionRS1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Plz=" & trim(rs4("plaza")) %>">
                                                                    <%= rs4("plaza") %>
                                                                </a>
                                                            </td>
                                                            <td>
