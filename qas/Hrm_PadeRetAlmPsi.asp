        ...
        <form name="form1" id="form1" method="post">
            <table style="padding: 4; border: 1; border-collapse: collapse; border-color: #dcdcdc">
                ...
                <tr>
                    ...
                    <td><input type="text" size="50" name="IdnPrs" id="IdnPrs" value="<%= Nem %>" required></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="text-align: right"><input type="button" value="Enviar" id="btn1" class="button" onclick="soapRequest1(<%= Nem %>);"></td>
                </tr>
            </table>
            </br>
            </br>
