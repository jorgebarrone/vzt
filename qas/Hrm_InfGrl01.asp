                                                ...
                                                <div class="box-body table-responsive no-padding">
                                                    <table style="text-align: center; width: 100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr style="text-align: center; vertical-align: bottom">
                                                                <td><a href="images/templates/verzatec-template-staff.ppt"    download="verzatec-template-staff.ppt">Descargar</a></td>
                                                                <td><a href="images/templates/verzatec-template-stabilit.ppt" download="verzatec-template-stabilit.ppt">Descargar</a></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>  
                                                </div>
