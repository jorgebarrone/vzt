...
'           response.write(sqlupd)
    ...
    <section class="content">
        ...
        <form action="Hrm_PadeEnc3603.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Eid=" & Eid & "&Nem=" & Nem & "&Nmb=" & Nmb & "&Cid=" & Cid & "&Sid=" & Sid %>" name="form1" onsubmit="return validate();" method="post">
