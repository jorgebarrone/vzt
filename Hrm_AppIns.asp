        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                if Cid = "2" then
                    ...
                    <a class="btn btn-block btn-social btn-bitbucket" style="background-color: #868483" href="http://sinet2a/ImpulsaNet" target="_blank">
                        <i class="fa fa-bullseye"></i> Impulsa
                    </a>
                    <a class="btn btn-block btn-social btn-bitbucket" style="background-color: #A53148" href="http://sinet2a/BaseConocimiento/" target="_blank">
                    ...
                    <a class="btn btn-block btn-social btn-bitbucket" style="background-color: #A53148" href="http://sinet2a/SolicitudFondos/SF_Solicitudes.asp?op=1" target="_blank">
