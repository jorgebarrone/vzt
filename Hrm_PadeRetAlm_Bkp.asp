            ...
            <div class='col-xs-12'>
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#" onclick="soapRequest1(<%= Nem %>);">Descargar Psicometría</a>
                        </li>
                        <li>
                            <a href="#desempeno" data-toggle="tab" onclick="ClkTab();">Desempeño</a>
                        </li>
                        <li>
                            <a href="#acciones" data-toggle="tab">Acciones de Retroalimentacion</a>
                        </li>
                    </ul>
                                                ...
                                                <div class="box-body">
                                                    <div class="table-responsive" style="font-size: small">
                                                        <table class="table no-margin">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>PROCESO PADE 2017</td>
                                                                    <td>95.00</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>PROCESO PADE 2016</td>
                                                                    <td>94.37</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                ...
                                <div class="box-body">
                                    <div class="box box-info box-solid">
                                        ...
                                        <div class="box-body" style="font-size: small">
                                            <form action="Hrm_PadeRetAlm.asp?Prm=4&Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Sid=" & Sid %>" name="form4" method="post">
                                                <div class="row fontawesome-icon-list">
                                                    <div class="col-md-3 col-sm-4">
                                                        <div class="form-group">
                                                            <label style="color: #f00">* &nbsp;</label><label>Tipo Area</label>
                                                            <input type="text" class="form-control" name="DfmNmb" id="DfmNmb" maxlength="100" required />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-sm-4">
                                                        <div class="form-group">
