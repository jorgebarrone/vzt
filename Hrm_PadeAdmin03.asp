...
<head>
  ...
  <title>HRM Verzatec | PADE Administrador 03</title>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="Listado" >
                                    ...
                                    <div class="box box-success">
                                        <form action="Hrm_PadeAdmin03.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Prm=3" & "&Sid=" & Sid %>" name="form1" method="post">
                                            <!-- form start -->
                                            <div class="box-body">
