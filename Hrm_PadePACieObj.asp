...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if Tvl = 2 then
        response.redirect "Hrm_PadePACieObjE.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc
    end if
    ...
    if Sbt4 = "Sbt4" then
        ...
        if Ind > "" then
            ...
            TskScr = "Hrm_PadeAutCieObj.asp?Mdl=" & Mdl &  "&Trn=" & Trn & "&Ejr=" & Ejr & "&Nem=" & Eid & "&Nmb=" & Enm & "&Dsc=" & Dsc & "&Cid=" & Cid
            TskDsc = Dsc & " - " & TskTx4
...
'            response.redirect "Hrm_EmpPade.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid 
    ...
    <section class="content">
        <div class="box box-success">
            <form action="Hrm_PadePACieObj.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1" method="post">
                ...
                if not rsO.bof and not rsO.eof then
                    ...
                    <div class="box box-primary">
                        <form action="Hrm_PadePACieObj.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1a" method="post">
<!--
                                        ...
                                        if not rsS.bof and not rsS.eof then
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <a href="Hrm_PadePACnsCieObj1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Eid=" & Eid & "&Ejr=" & Eja & "&Dsc=" & Dsc & "&Ptd=" & rsO("Pod_Partida") %>">
                                                        <%= rsO("Pod_Ponderacion") %>
                                                    </a>
                                                </td>
                                                <td>
