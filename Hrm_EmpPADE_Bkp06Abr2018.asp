...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   '<!-- Buscamos si se trata de una consulta de un Ejercicio en especifico, de lo contrario mostramos la información del Ejercicio que esté activo -->
    ...
    sqlCia = "select Emp_CompaniaID, Emp_NombreCompleto from HRM10220 where Emp_Empleadoid = '"& Eid &"' "
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    if not rsM3.bof and not rsM3.eof then
                                        ...
                                        Do while not rsM3.eof
                                            ...
                                            if date >= P1FecIniD and date <= P1FecFinD then
                                                if CInt(rsM3("Psm_Estatus")) = 0 then
                                                    ...
                                                    semelm = "red"
                                                    %>
                                                    <li><a href="Hrm_PadeEnc3604.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Eid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsM3("Trd_Texto") %></a></li>
                                                    <%
                                                else
                                                    if CInt(rsM3("Psm_Estatus")) = 1 then
                                                        ...
                                                        semelm = "green"
                                                        %>
                                                        <li><a href="Hrm_PadeCnsM360.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Eid & "&Nmb=" & Enm & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Cid=" & Cid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsM3("Trd_Texto") %></a></li>
                                                        <%
                                                    end if
                                                end if
                                            else
                                        ...
                                        sqlClb = "select b.Psm_Estatus,        c.Emp_EmpleadoID, " & _
                                                 ...
                                                 "and   b.Psm_Ejercicio     =  "& Ejr &"         " & _
                                                 "and   a.Psf_Seccion       = 'MAT360'           " & _
                                                 "and   c.Emp_PlazaSuperior = '"& PlzSup &"'     "
                                                ...
                                                if date >= P1FecIniD and date <= P1FecFinD then
                                                    if rsClb("Psm_Estatus") = 0 then
                                                        ...
                                                        if rsClb("Psm_Estatus") = 1 then
                                                            ...
                                                            semelm = "yellow"
                                                            %>
                                                            <li><a href="Hrm_PadeAutM360.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & trim(rsClb("Emp_EmpleadoID")) & "&Nmb=" & trim(rsClb("Emp_NombreCompleto")) & "&Cid=" & trim(rsClb("Emp_CompaniaID")) & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsClb("Emp_NombreCompleto") %></label></a></li>
                                                            <%
                                                        else
                                                            semelm = "green"
                                                            %>
                                                        ...
                                                        if date >= P1FecIniD and date <= P1FecFinD then
                                                            if rsClv("Psm_Estatus") = 0 then
                                                                ...
                                                                if rsClv("Psm_Estatus") = 1 then
                                                                    ...
                                                                    semelm = "yellow"
                                                                    %>
                                                                    <li><a href="Hrm_PadeAutM360.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & trim(rsClv("Emp_EmpleadoID")) & "&Nmb=" & trim(rsClv("Emp_NombreCompleto")) & "&Cid=" & trim(rsClv("Emp_CompaniaID")) & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsClv("Emp_NombreCompleto") %></label></a></li>
                                                                    <%
                                                                else
                                                                    semelm = "green"
                                                                    %>
                                    ...
                                    if not rsEnc.bof and not rsEnc.eof then
                                        ...
                                        Do while not rsEnc.eof
                                            ...
                                            if date >= P1FecIniD and date <= P1FecFinD then
                                                %>
                                                <li><a href="Hrm_PadeAutEnc.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Eid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsEnc("Emp_NombreCompleto") %></label></a></li>
                                                <%
                                            else
                                                %>
                                    ...
                                    if not rsEnc.bof and not rsEnc.eof then
                                        ...
                                        Do while not rsEnc.eof
                                            ...
                                            if date >= P1FecIniD and date <= P1FecFinD then
                                                %>
                                                <li><a href="Hrm_PadeEnc3603.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & trim(rsEnc("M36_EmpleadoID")) & "&Nmb=" & trim(rsEnc("Emp_NombreCompleto")) & "&Cid=" & trim(rsEnc("Emp_CompaniaID")) & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= trim(rsEnc("Emp_NombreCompleto")) %></label></a></li>
                                                <%
                                            else
                                                %>
                                                <li><a href="#"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsEnc("Emp_NombreCompleto") %></label></a></li>
                                    ...
                                    if Tvl < 3 then
                                        ...
                                        if not rsP3.bof and not rsP3.eof then
                                            ...
                                            Do while not rsP3.eof
                                                ...
                                                if date >= P1FecIniD and date <= P1FecFinD then
                                                    %>
                                                    <li><a href="Hrm_PadeAprObj.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Eid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP3("Trd_Texto") %></a></li>
                                                    <%
                                                else
                                                    %>
                                                    ...
                                                    if date >= P1FecIniD and date <= P1FecFinD then
                                                        if rsClb("Psm_Estatus") = 0 then
                                                            ...
                                                            if rsClb("Psm_Estatus") = 1 then
                                                                ...
                                                                semelm = "green"
                                                                %>
                                                                <li><a href="Hrm_PadeCnsAprObj.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & trim(rsClb("Emp_EmpleadoID")) & "&Nmb=" & trim(rsClb("Emp_NombreCompleto")) & "&Cid=" & trim(rsClb("Emp_CompaniaID")) & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsClb("Emp_NombreCompleto") %></label></a></li>
                                                                <%
                                                            end if
                                                        end if
                                                    else
                                                ...
                                                if Tvl < 3 then
                                                    if date >= P2FecIniD and date <= P2FecFinD then
                                                        if CInt(rsP3("Psm_Estatus")) = 0 then
                                                            ...
                                                            semelm = "red"
                                                            %>
                                                            <li><a href="Hrm_PadeCieObj.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Eid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP3("Trd_Texto") %></a></li>
                                                            <%
                                                        else
                                                            if CInt(rsP3("Psm_Estatus")) = 1 then
                                                                P2Est = P2Est + 1
                                                                ...
                                                                semelm = "green"
                                                                %>
                                                                <li><a href="Hrm_PadeCnsCieObj.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Eid & "&Nmb=" & Enm & "&Cid=" & Cid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP3("Trd_Texto") %></a></li>
                                                                <%
                                                            end if
                                                        end if
                                                    else
                                                    ...
                                                    if date >= P2FecIniD and date <= P2FecFinD then
                                                        if CInt(rsP3("Psm_Estatus")) = 0 then
                                                            ...
                                                            if CInt(rsP3("Psm_Estatus")) = 1 then
                                                                ...
                                                                semelm = "green"
                                                                %>
                                                                <li><a href="Hrm_PadeCnsCieHab.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Eid & "&Nmb=" & Enm & "&Cid=" & Cid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP3("Trd_Texto") %></a></li>
                                                                <%
                                                            end if
                                                        end if
                                                    else
                                                        ...
                                                        if date >= P2FecIniD and date <= P2FecFinD then
                                                            if rsClb("Psm_Estatus") = 0 then
                                                                ...
                                                                if rsClb("Psm_Estatus") = 1 then
                                                                    ...
                                                                    semelm = "yellow"
                                                                    %>
                                                                    <li><a href="Hrm_PadeAutCieObj.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & trim(rsClb("Emp_EmpleadoID")) & "&Nmb=" & trim(rsClb("Emp_NombreCompleto")) & "&Cid=" & trim(rsClb("Emp_CompaniaID")) & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsClb("Emp_NombreCompleto") %></label></a></li>
                                                                    <%
                                                                else
                                                                    semelm = "green"
                                                                    %>
                                        ...
                                        Do while not rsP4.eof
                                            ...
                                            if date >= P2FecIniD and date <= P2FecFinD then
                                                if CInt(rsP4("Psm_Estatus")) = 0 then
                                                    ...
                                                    semelm = "red"
                                                    %>
                                                    <li><a href="Hrm_PadeRetAlm.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & Eid & "&Nmb=" & Enm & "&Cid=" & Cid & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP4("Trd_Texto") %></a></li>
                                                    <%
                                                else
                                                ...
                                                if CInt(rsP4("Psm_Estatus")) = 0 then
                                                    ...
                                                    semelm = "red"
                                                    %>
                                                    <li><a href="#"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP4("Trd_Texto") %></a></li>
                                                    <%
                                                else
                                                    if CInt(rsP4("Psm_Estatus")) = 1 then
                                                        P2Est = P2Est + 1
                                            ...
                                            do while not rsClb.eof
                                                if date >= P2FecIniD and date <= P2FecFinD then
                                                    if rsClb("Psm_Estatus") = 0 then
                                                        ...
                                                        semelm = "red"
                                                        %>
                                                        <li><a href="Hrm_PadeRetAlm.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & trim(rsClb("Emp_EmpleadoID")) & "&Nmb=" & trim(rsClb("Emp_NombreCompleto")) & "&Cid=" & trim(rsClb("Emp_CompaniaID")) & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsClb("Emp_NombreCompleto") %></label></a></li>
                                                        <%
                                                    else
                                                        if rsClb("Psm_Estatus") = 1 then
                                                            P2Est = P2Est + 1
                                                    ...
                                                    do while not rsClv.eof
                                                        if date >= P2FecIniD and date <= P2FecFinD then
                                                            if rsClv("Psm_Estatus") = 0 then
                                                                ...
                                                                semelm = "red"
                                                                %>
                                                                <li><a href="Hrm_PadeRetAlm.asp?Ejr=<%= Ejr & "&Dsc=" & Dsc & "&Nem=" & trim(rsClv("Emp_EmpleadoID")) & "&Nmb=" & trim(rsClv("Emp_NombreCompleto")) & "&Cid=" & trim(rsClv("Emp_CompaniaID")) & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<label style="font-size: x-small"><%= rsClv("Emp_NombreCompleto") %></label></a></li>
                                                                <%
                                                            else
                                                                if rsClv("Psm_Estatus") = 1 then
                                                                    P2Est = P2Est + 1
                                        ...
                                        <li class="treeview">
                                            ...
                                            Do while not rsP1.eof
                                                ...
                                                if date >= P3FecIniD and date <= P3FecFinD then
                                                    %>
                                                    <li><a href="Hrm_PadeP1DG.asp?Prm=<%= Prm & "&Ejr=" & Ejr & "&Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid %>"><i class="fa fa-arrow-circle-right text-<%= semelm %>"></i>&nbsp;<%= rsP1("Trd_Texto") %></a></li>
                                                    <%
                                                else
                                                    %>
