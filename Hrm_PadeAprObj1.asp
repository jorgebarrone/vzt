...
<head>
  ...
  <title>HRM Verzatec | Modificación de Objetivos Empleados PADE</title>
      ...
      '                  TotPnd = CInt(Request.Form("ObjPnd"))
       '             end if
        ...
        if TotPnd > 100 then
            ...
            response.redirect "Hrm_PadeAprObj.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Eid=" & Eid
'            response.write(sqlins)
    ...
    <section class="content">
        <div class="box box-success">
            <form action="Hrm_PadeAprObj1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid & "&Ptd=" & Ptd %>" name="form1" method="post">
                    ...
                    <div class="row fontawesome-icon-list">
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="form-group">
                                ...
                                <br/>
                                <button type="submit" class="btn btn-primary" name="Sbt1" id="Sbt1" value="Sbt1"><%= SmBtn7 %></button>
                            </div>
                        </div>
                    </div>
                </div>
