                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="<%= Pan11St %>" id="main" >
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#Listado" data-toggle="tab"><%= BxHd08 %></a></li>
                                <%
                                if Sb3 = "Sb3" then
                                  %>
                                  <li><a href="Hrm_PadeAdmin11Pdf.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Eid=" & Eid & "&Sid=" & Sid %>"><%= BxHd07 %></a></li>
                                  <%
                                end if
                                %>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="Listado" >
                                    ...
                                    <div class="box box-success">
                                        <form action="Hrm_PadeAdmin11.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Prm=11" & "&Sid=" & Sid %>" name="form1" method="post">
                                            <!-- form start -->
                                            <div class="box-body">
