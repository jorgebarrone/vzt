...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    sqlCia = "select Emp_CompaniaID, Emp_PlazaID, Emp_PlazaSuperior, Emp_Email from HRM10220 where Emp_Empleadoid = '"& Eid &"' "
...
'        end if
    ...
    <!-- CONTENIDO PRINCIPAL AQUI -->
        <div class="box box-primary">
            ...
            <form action="Hrm_PadePAEnc3604.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1" method="post">
                <!-- form start -->
                <div class="box-body">
                    <div class="row fontawesome-icon-list">
                        <div class="col-md-3 col-sm-4">
...
'            response.write(sqlEvl)
            if not rsO.bof and not rsO.eof then
                ...
                %>
                <div class="box box-primary">
                    <form action="Hrm_PadePAEnc3604.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1a" method="post">
                        <div class="box-header">
