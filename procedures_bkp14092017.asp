                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      ...
                      <h4>
                        Vacaciones
                        <small><i class="fa fa-clock-o" style="font-size: larger"></i> 5 mins</small>
                      </h4>
                      <p>Se ha autorizado tu Solicitud</p>
                    </a>
                  </li>
                  <!-- end message -->
                </ul>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> Evaluación 360° Pendiente
                    </a>
                  </li>
                </ul>
              </li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              ...
              if Tsk > 0 then
                  ...
                  sqlTsk = "select Tsk_FolioID, Tsk_Partida, Tsk_Descripcion, Tsk_Observaciones, Tsk_Script from HRM10400 where Tsk_EmpleadoID = '"& Uid &"' and Tsk_Estatus = 'A'  "
