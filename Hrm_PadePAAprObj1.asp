...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if Tvl = 2 then
        response.redirect "Hrm_PadeAprObjE.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc
    end if
      ...
      '                  TotPnd = CInt(Request.Form("ObjPnd"))
       '             end if
        ...
        if TotPnd > 100 then
            ...
            response.redirect "Hrm_PadePAAprObj.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc
'            response.write(sqlins)
    ...
    <section class="content">
        <div class="box box-success">
            <form action="Hrm_PadePAAprObj1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid & "&Ptd=" & Ptd %>" name="form1" method="post">
