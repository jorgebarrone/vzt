...
<head>
  ...
  <title>HRM Verzatec | Consulta Retroalimentación PADE</title>
...
%>
  ...
  <div class="content-wrapper">
    ...
    sqlImg = "select a.Emp_Foto,           a.Emp_Email,      " & _
             "       a.Emp_NombreCompleto, c.Pue_Descripcion " & _
    ...
    '<!-- Validamos es Estatus del Semaforo de la Retroalimentación del Empleado -->
    sqlEst = "select Psm_Estatus from HRM10502        " & _
    ...
    set rsEst = dbconn.execute(sqlEst)
    if not rsEst.bof and not rsEst.eof then
        SmfEst = CInt(rsEst("Psm_Estatus"))
    else
        SmfEst = 0
    end if
    ...
    if Sbt4b = "Sbt4b" then
        ...
        if PwdJin = "" or PwdClb = "" then
            ...
            dbconnk.open cnk
            sqlPJi = "select ID_Usuario from IN_Usuarios where Empleado = '"& Uid &"' and Contrasena = '"& PwdJin &"' "
                                                            ...
                                                            <div class="row fontawesome-icon-list">
                                                                <div class="col-md-3 col-sm-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        if SmfEst = 0 then
                                                                            %>
                                                                            <input type="password" class="form-control" name="PwdJin" id="PwdJin" disabled />
                                                                            <%
                                                                        else
                                                                            %>
                                                                ...
                                                                <div class="col-md-3 col-sm-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        if SmfEst <= 1 then
                                                                            ...
                                                                            %>
                                                                            <input type="password" class="form-control" name="PwdClb" id="PwdClb" disabled value="**********" />
                                                                            <%
                                                                        end if
                                                                        %>
                                                                    </div>
