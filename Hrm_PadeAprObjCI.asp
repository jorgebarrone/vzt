...
<head>
  ...
  <title>HRM Verzatec | Impresión de Objetivos Empleados/Ejecutivos PADE</title>
    ...
    function print01() {
        html2canvas(document.body, {
            onrendered: function (canvas) {
                ...
                doc.save('ConsultaObjetivos.pdf');
            }
        });
    }
</script>
...
<div class="wrapper">
  <% 'call men() %>
    ...
    sqlCia = "select Emp_CompaniaID, Emp_PlazaSuperior, Emp_Foto, Emp_NombreCompleto from HRM10220 where Emp_Empleadoid = '"& Eid &"' "
