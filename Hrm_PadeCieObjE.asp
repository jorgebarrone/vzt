...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if Tvl = 1 then
        response.redirect "Hrm_PadeCieObj.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Eid=" & Eid
    end if
...
'    response.write("HdrNim : " & HdrNim & ", HdrNmb : " & HdrNmb & ", HdrNml : " & HdrNml & ", HdrNpd : " & HdrNpd)
    ...
    <section class="content">
        <div class="box box-success">
            ...
            <form action="Hrm_PadeCieObjE.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1" method="post">
                <!-- form start -->
                <div class="box-body">
                <%
