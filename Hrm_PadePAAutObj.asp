...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if Tvl = 2 then
        response.redirect "Hrm_PadePAAutObjE.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Nem=" & Nem & "&Nmb=" & Nmb & "&Dsc=" & Dsc & "&Cid=" & Cid
    end if
...
'        response.write("</br>")
        ...
        TskScr = "Hrm_PadeAprObj.asp?Mdl=" & Mdl &  "&Trn=" & Trn & "&Ejr=" & Ejr & "&Nem=" & Eid & "&Nmb=" & Enm & "&Dsc=" & Dsc & "&Cid=" & Cid
        TskDsc = Dsc & " - " & TskTx2
...
'        response.redirect "Hrm_EmpPade.asp?Mdl=" & Mdl & "&Trn=" & Trn & "&Sid=" & Sid 
    ...
    <section class="content">
        <div class="box box-success">
            <form action="Hrm_PadePAAutObj.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid & "&Eid=" & Eid & "&Nem=" & Nem & "&Nmb=" & Nmb & "&Cid=" & Cid %>" name="form1" method="post">
