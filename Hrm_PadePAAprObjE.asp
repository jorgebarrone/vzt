...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    sqlCia = "select Emp_CompaniaID, Emp_PlazaSuperior, Emp_Email, Emp_NombreCompleto, Emp_Foto from HRM10220 where Emp_Empleadoid = '"& Eid &"' "
    ...
    <section class="content">
      <div class="box box-success">
        ...
        <div class="box box-primary">
            <form action="Hrm_PadePAAprObjE.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1" method="post">
            ...
            if not rsO.bof and not rsO.eof then
                ...
                %>
                <div class="box box-primary">
                    <form action="Hrm_PadePAAprObjE.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Sid=" & Sid %>" name="form1a" method="post">
                        <div class="box-header">
                        ...
                        <div class="box-body">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            if trim(rsO("Pod_Descripcion")) = "UAFIR" then
                                                ...
                                                %>
                                                <a href="Hrm_PadePAAprObjE1.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc & "&Ptd=" & rsO("Pod_Partida") %>">
                                                    <%= rsO("Pod_Ponderacion") %>
                                                </a>
                                                <%
                                            end if
                            ...
                            <div class="box-footer" style="text-align: center">
                                ...
                                if TotPnd = 100 then
                                    if SobPnd = 0 then
                                        %>
                                        <a href="Hrm_PadePAAprObjIE.asp?Mdl=<%= Mdl & "&Trn=" & Trn & "&Sid=" & Sid & "&Eid=" & Eid & "&Ejr=" & Ejr & "&Dsc=" & Dsc %>" target="_blank" ><button type="button" class="btn btn-primary" name="Sbt3" id="Sbt3" value="Sbt3"><%= SmBtn3 %></button>&nbsp;&nbsp;&nbsp;</a>
